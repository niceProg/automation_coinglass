...
💰 SPOT MARKET:
    ...
    # spot_large_orderbook_history   Historical data for large limit orders [DISABLED]
    spot_aggregated_taker_volume_history  Aggregated taker buy/sell volumes across exchanges
    # spot_taker_volume_history        Single exchange taker buy/sell volume data [DISABLED]
    spot_ask_bids_history            Historical orderbook bid/ask data with depth ranges
    # spot_aggregated_ask_bids_history      Aggregated orderbook bid/ask data across exchanges (spot) [DISABLED]
    futures_aggregated_ask_bids_history  Aggregated orderbook bid/ask data across exchanges (futures)
...
Usage Examples:
    ...
    python main.py spot_coins_markets spot_pairs_markets spot_price_history spot_large_orderbook # spot_large_orderbook_history [DISABLED] spot_aggregated_taker_volume_history # spot_taker_volume_history [DISABLED] spot_ask_bids_history # spot_aggregated_ask_bids_history [DISABLED] futures_aggregated_ask_bids_history
...
def show_help():
    ...
    logger.info("  python main.py spot_large_orderbook # spot_large_orderbook_history [DISABLED]")
    logger.info("  python main.py spot_aggregated_taker_volume_history # spot_taker_volume_history [DISABLED]")
    logger.info("  python main.py spot_ask_bids_history # spot_aggregated_ask_bids_history [DISABLED] futures_aggregated_ask_bids_history")
    logger.info("  ")
...
def main():
    ...
    parser.add_argument(
        ...
        "Spot: spot_coins_markets, spot_pairs_markets, spot_price_history, spot_large_orderbook, spot_large_orderbook_history [DISABLED], spot_aggregated_taker_volume_history, spot_taker_volume_history [DISABLED], spot_ask_bids_history, spot_aggregated_ask_bids_history [DISABLED]\n"
        "Futures: futures_aggregated_ask_bids_history\n"
