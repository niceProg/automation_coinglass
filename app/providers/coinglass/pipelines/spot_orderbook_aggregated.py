"""Spot Orderbook Aggregated Pipeline"""
...
def run(conn, client, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Endpoint: /api/spot/orderbook/aggregated

    Retrieves aggregated spot orderbook data across multiple exchanges,
    providing a consolidated view of market depth.
    """
