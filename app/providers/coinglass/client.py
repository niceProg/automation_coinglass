...
class CoinglassClient:
    ...
    # ---------- Futures Orderbook ----------
    def get_futures_aggregated_ask_bids_history(
        self,
        exchange_list: str,
        symbol: str,
        ...
        """
        Get Futures Aggregated Orderbook Bid&Ask History - Aggregated orderbook data across multiple exchanges for futures.
    ...
    def get_spot_ask_bids_history(
        ...
        """
        Get Spot Orderbook Bid&Ask History - Historical orderbook data with bid/ask ranges.
    ...
    def get_spot_aggregated_ask_bids_history(  # [DISABLED - Pipeline not active]
        ...
        """
        Get Spot Aggregated Orderbook Bid&Ask History - Aggregated orderbook data across multiple exchanges.
